...
function Get-PhpIpamdevice {
    ...
    process {
        if ($PSCmdlet.ParameterSetName -eq 'ByName') {
            $r=Invoke-PhpIpamExecute -ContentType "application/json" -method get -controller devices -identifiers @("search",$name) -PhpIpamSession $PhpIpamSession
        }
        if ($PSCmdlet.ParameterSetName -eq 'ByID') {
            $r=Invoke-PhpIpamExecute -ContentType "application/json" -method get -controller devices -identifiers @($ID) -PhpIpamSession $PhpIpamSession
        }
